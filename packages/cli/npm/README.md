...
[![Release](https://img.shields.io/github/v/release/keywaysh/keyway?label=release&color=34D399)](https://github.com/keywaysh/keyway/releases/latest)
...
[![codecov](https://codecov.io/github/keywaysh/keyway/graph/badge.svg?token=O3LRCDFKLS)](https://codecov.io/github/keywaysh/keyway)
...
Grab the binary for your platform from [Releases](https://github.com/keywaysh/keyway/releases).
