      ...
      mockFetch.mockResolvedValueOnce({
        ...
        json: () => Promise.resolve({
          data: {
            ...
            prices: {
              team: { monthly: { id: 'price_team_m', price: 1900, interval: 'month' }, yearly: { id: 'price_team_y', price: 19000, interval: 'year' } },
              business: { monthly: { id: 'price_biz_m', price: 3900, interval: 'month' }, yearly: { id: 'price_biz_y', price: 39000, interval: 'year' } },
              },
          },
      ...
      mockFetch.mockResolvedValueOnce({
        ...
        json: () => Promise.resolve({
          data: {
            ...
            prices: { team: null, business: null },
          },
          meta: { requestId: 'req-1' },
        }),
      })
